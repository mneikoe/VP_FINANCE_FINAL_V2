...
const CustomerDetail = () => {
  ...
  const fillimage = async (firstId, secondID, image) => {
    ...
    dispatch(updateImage({ firstId, secondID, image }))
      .unwrap()
      .then((res) => {
        console.log(res);
  ...
  const init = async () => {
    ...
    console.log("Task History Data:", res?.client?.taskHistory);
              ...
              <>
                ...
                >
                  ...
                  <input
                    ...
                    style={{ display: "none" }}
                    accept="image/*"
                    onChange={(e) => handleFileChangeimage(e)}
                  />
                </div>
              </>
            ) : (
              ...
              <div className="profile-details">
                <div className="detail-item">
                  ...
                  <div>
                    ...
                    <p className="detail-value ">
                      {userData?.personalDetails?.leadOccupation || "N/A"}
                    </p>
                  </div>
                ...
                <div className="detail-item">
                  ...
                  <div>
                    ...
                    <p className="detail-value ">
                      {userData?.personalDetails?.leadOccupationType || "N/A"}
                    </p>
                  </div>
                ...
                <div className="detail-item">
                  ...
                  <div>
                    ...
                    <p className="detail-value">{userData?.status || "N/A"}</p>
                  </div>
                </div>
                <div className="detail-item">
                  {/* <FiMail className="detail-icon" /> */}
                  ...
                  <div>
                    ...
                    <p className="detail-value">
                      {userData?.familyMembers?.reduce(
                        (sum, member) => sum + Number(member.annualIncome || 0),
                        0
                      ) || "N/A"}
                    </p>
                  </div>
            ...
            <div className="info-cards">
              ...
              <div className="info-card">
                ...
                <div>
                  ...
                  <p>{userData?.personalDetails?.leadName || "N/A"}</p>
                </div>
              </div>
            </div>
            ...
            <div className="tabs-container">
              ...
              >
                <TabList className="custom-tablist">
                  ...
                  <Tab
                    className={`custom-tab ${tabIndex === 7 ? "active" : ""}`}
                  >
                              ...
                              <div className="col-md-6">
                                <div className="detail-item d-flex align-items-center mb-3">
                                  <div className="d-flex flex-grow-1">
                                    ...
                                    <span className="fw-semibold">
                                      {userData?.personalDetails?.groupName ||
                                        "N/A"}
                                    </span>
                                  </div>
                                </div>
                    ...
                    userData?.proposedPlan?.length > 0 ? (
                      ...
                      <div className="text-center py-5">
                        ...
                        <button className="btn btn-primary mt-3">
                          ...
                          <Link to={`/client/proposed}`}>Add New Plan</Link>
                        </button>
                      </div>
                    )}
                  </div>
                    ...
                    userData.taskHistory.length > 0 ? (
                      ...
                      <div className="text-center py-5">
                        ...
                        >
                          ...
                          <p className="mb-0">
                            No task history available for this client.
                          </p>
                        </div>
                      </div>
                    )}
