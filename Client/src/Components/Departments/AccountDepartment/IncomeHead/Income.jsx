...
const Income = () => {
  ...
  useEffect(() => {
    dispatch(fetchIncomeExpenseDropdown("income"));
    dispatch(fetchBanks());
  }, [dispatch]);
  ...
  return (
    <div className="p-4">
      <h4 className="mb-4">Income Entry</h4>
          ...
          <div className="col-md-2">
            ...
            {selectedBank && (
              <div className="mt-1 d-flex gap-2">
                <span className="badge bg-success">{selectedBank.bankName}</span>
                <button
