      ...
      <Modal
        title={
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '95%' }}>
            <Space><EyeOutlined style={{ color: '#1890ff' }} /> Interview Evaluation Profile</Space>
            {selectedCandidate && (
            ...
            <Row gutter={24} style={{ marginBottom: 24 }}>
                <Col span={16}>
                    ...
                    >
                        ...
                        {selectedCandidate.interviewPlace && (
                            <Descriptions.Item label="Interview Place" span={2}>{selectedCandidate.interviewPlace}</Descriptions.Item>
                        )}
                        {selectedCandidate.interviewDate && (
                            <Descriptions.Item label="Interview Date" span={2}>
                              <Text type="warning">{dayjs(selectedCandidate.interviewDate).format("DD MMM YYYY, hh:mm A")}</Text>
                            </Descriptions.Item>
                        )}
                    </Descriptions>
                </Col>
